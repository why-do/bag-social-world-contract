...
contract Token {
    ...
    constructor() public {
        owner = msg.sender;
        totalSupply = 100 * 10 ** uint256(decimals);  // 供应的份额，份额跟最小的代币单位有关，份额 = 币数 * 10 ** decimals。
        balanceOf[msg.sender] = totalSupply;          // 创建者拥有所有的代币
        name = "BagGoldenToken";                      // 代币名称
        symbol = "BGT";                               // 代币符号
        authorizedCaller[msg.sender] = true;          // 给予转移代币权限
    }
     ...
     * @param _value 转移数额
     */
    function ownerTransfer(address _to, uint256 _value) public onlyAuthorizedCaller{
     ...
     * @param _value 转移数额
     */
    function userTransfer(address _from, address _to, uint256 _value) internal returns (bool success) {
